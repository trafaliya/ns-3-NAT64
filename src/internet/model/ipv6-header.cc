...
void Ipv6Header::SetDestinationAddress (Ipv4Address dst)
{
  m_destinationAddress1 = dst;
}
...
Ipv4Address Ipv6Header::GetDestinationv4Address () const
{
  return m_destinationAddress1;
}
