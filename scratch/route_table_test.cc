...
main (int argc, char *argv[])
{
  ...
  Simulator::Schedule (Seconds (0.0), &StackHelper::PrintRoutingTable, &stackHelper, first.Get(0));
  Simulator::Schedule (Seconds (0.0), &StackHelper::PrintRoutingTable, &stackHelper, first.Get(1));
  Simulator::Schedule (Seconds (0.0), &StackHelper::PrintRoutingTable, &stackHelper, second.Get(1));
